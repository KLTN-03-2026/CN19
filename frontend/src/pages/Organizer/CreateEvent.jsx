             ...
             <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                    ...
                    <input 
                        ...
                        className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-sm font-bold placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:outline-none focus:border-blue-600 transition-all"
             ...
             <div className="space-y-2">
                ...
                <div className="relative group cursor-pointer" onClick={() => setIsMapModalOpen(true)}>
                    <input 
                        ...
                        readOnly
                        className="w-full bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-sm font-bold placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:outline-none focus:border-blue-600 transition-all cursor-pointer pr-12"
          ...
          <div className="space-y-8 animate-in slide-in-from-right-8 fade-in duration-500">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                    <h3 className="text-lg font-bold text-gray-900 dark:text-white uppercase er">Cấu hình hạng vé</h3>
                    <p className="text-[10px] text-gray-700 dark:text-white font-bold uppercase ">Tạo ít nhất một hạng vé để mở bán</p>
                </div>
                <button 
                    type="button"
                    onClick={() => append({ tier_name: '', price: '', quantity_total: '', section_name: '', benefits: '' })}
                    className="flex items-center bg-blue-600 text-white px-5 py-2 rounded-xl text-[10px] font-bold uppercase  hover:brightness-110 transition-all shadow-lg shadow-blue-600/20"
                >
                ...
                {fields.map((field, index) => (
                    <div key={field.id} className="p-6 bg-gray-50 dark:bg-white/[0.03] border border-gray-200 dark:border-white/5 rounded-2xl relative group-item transition-all hover:border-blue-600/30">
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div className="space-y-1">
                                ...
                                <input 
                                    ...
                                    className="w-full bg-transparent border-b border-gray-200 dark:border-white/20 py-1 text-sm font-bold placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:outline-none focus:border-blue-600 transition-all"
                            ...
                            <div className="space-y-1">
                                ...
                                <input 
                                    ...
                                    className="w-full bg-transparent border-b border-gray-200 dark:border-white/20 py-1 text-sm font-bold placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:outline-none focus:border-blue-600 transition-all placeholder:text-gray-300 dark:placeholder:text-gray-600"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-4">
                            <div className="space-y-1">
                                <label className="text-[10px] font-black uppercase  text-gray-600 dark:text-gray-400 italic">Khu vực / Chỗ ngồi (Tùy chọn)</label>
                                <input 
                            ...
                            <div className="space-y-1">
                                <label className="text-[10px] font-black uppercase  text-gray-600 dark:text-gray-400 italic">Quyền lợi (Tùy chọn)</label>
                                <input 
                                    {...register(`ticket_tiers.${index}.benefits`)}
                                    className="w-full bg-transparent border-b border-gray-200 dark:border-white/20 py-1 text-sm font-medium placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:outline-none focus:border-blue-600 transition-all"
        ...
        {step === 4 && (
          <div className="space-y-8 animate-in slide-in-from-right-8 fade-in duration-500">
             <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                    <h4 className="text-xs font-bold uppercase  text-blue-600">Phí và Luật Marketplace</h4>
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="relative">
                            <div className="w-full bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10 rounded-xl px-4 py-3 text-sm font-bold opacity-70 flex justify-between items-center">
