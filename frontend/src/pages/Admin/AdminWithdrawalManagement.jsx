            ...
            <div className="max-w-[1400px] mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700 tracking-tight">
                ...
                <div className="flex flex-col gap-6">
                    <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div>
                            ...
                            <p className="text-[11px] text-slate-700 dark:text-zinc-500 mt-1 font-bold uppercase tracking-tight">Duyệt yêu cầu rút tiền từ số dư ví của Khách hàng và Ban tổ chức</p>
                        </div>

                        <div className="flex items-center gap-3">
                            <button 
                                onClick={fetchWithdrawals}
                                className="p-3 bg-white dark:bg-zinc-900 rounded-xl border border-gray-200 dark:border-zinc-800/80 hover:border-neon-green/50 transition-all text-slate-700 hover:text-neon-green shadow-sm active:scale-95"
                            >
                ...
                {loading && filteredWithdrawals.length === 0 ? (
                                ...
                                <div className="p-6 flex-1 flex flex-col">
                                    <div className="flex items-start justify-between mb-4">
                                        <div className="flex items-center gap-4">
                                            <div className="w-12 h-12 rounded-2xl bg-slate-100 dark:bg-zinc-800 flex items-center justify-center shrink-0 border border-gray-200 dark:border-zinc-700 group-hover:border-neon-green/30 transition-all">
                                                <User className="w-6 h-6 text-slate-700 dark:text-gray-400" />
                                            </div>
                                            <div>
                                                ...
                                                <div className="text-[10px] text-slate-700 dark:text-gray-400 font-black uppercase tracking-tight mt-0.5 flex items-center gap-2">
                                        ...
                                        <div className="text-right">
                                            <p className="text-[10px] font-black text-slate-700 dark:text-gray-500 uppercase mb-1">SỐ TIỀN RÚT</p>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 p-4 bg-slate-50/80 dark:bg-zinc-950/80 rounded-[1.5rem] border border-gray-200 dark:border-zinc-800/80 mb-5 shadow-inner">
                                        <div className="space-y-1">
                                            <div className="text-[9px] font-black text-slate-700 dark:text-gray-400 uppercase tracking-tight">Thực nhận (NET)</div>
                                    ...
                                    <div className="mt-auto flex items-center justify-between pt-1">
                                        <div className="flex items-center gap-3">
                                            <div className="p-2 bg-slate-100 dark:bg-zinc-800 rounded-lg">
                                                <Wallet className="w-3.5 h-3.5 text-slate-700 dark:text-gray-400" />
                                            </div>
                                            <div className="text-[10px] font-black text-slate-700 dark:text-gray-400 uppercase">
                                        ...
                                        {item.status === 'pending' ? (
                                            ...
                                            <div className="text-[10px] font-black text-slate-700 dark:text-gray-500 uppercase opacity-80 tracking-tight">
                                                {item.status === 'approved' ? 'COMPLETED' : 'REJECTED'}
                                            </div>
                                        )}
                                    </div>
                                </div>
                    ...
                    <div className="text-center py-28 bg-white dark:bg-zinc-900/50 rounded-[2.5rem] border-2 border-dashed border-gray-200 dark:border-zinc-800 shadow-sm">
                        ...
                        <p className="text-slate-700 dark:text-gray-500 text-[11px] mt-2 font-bold uppercase tracking-tight">Danh sách yêu cầu rút tiền đang trống ở trạng thái này</p>
                    </div>
                )}
            </div>
                ...
                <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                    ...
                    <div className="relative bg-white dark:bg-zinc-950 w-full max-w-lg rounded-[2.5rem] border border-gray-100 dark:border-zinc-800 shadow-2xl overflow-hidden animate-in zoom-in-95 duration-300">
                        ...
                        <div className="px-10 py-8 border-b border-gray-100 dark:border-zinc-800/50 bg-gray-50/50 dark:bg-zinc-900/30">
                             ...
                             <p className="text-[11px] text-slate-700 dark:text-zinc-500 font-black uppercase tracking-tight mt-2 ml-14">ID: #{selectedRequest.id.slice(0, 8)}...</p>
                        </div>
                        ...
                        <div className="p-10 space-y-8">
                            ...
                            <div className="p-6 bg-slate-50/80 dark:bg-zinc-900/80 rounded-[2rem] border border-gray-200 dark:border-zinc-800">
                                <div className="space-y-4">
                                    <div>
                                        <span className="text-[10px] text-slate-700 font-black uppercase tracking-tight block mb-1">Số tài khoản thụ hưởng</span>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 pt-4 border-t border-gray-200 dark:border-zinc-800">
                                        <div>
                                            <span className="text-[10px] text-slate-700 font-black uppercase tracking-tight block mb-1">Chủ tài khoản</span>
                                        ...
                                        <div>
                                            <span className="text-[10px] text-slate-700 font-black uppercase tracking-tight block mb-1">Ngân hàng</span>
                            ...
                            <div className="flex items-center justify-between px-2">
                                <div>
                                    <span className="text-[10px] text-slate-700 font-black uppercase tracking-tight block mb-1">Số tiền chuyển (NET)</span>
                                    <span className="font-black text-neon-green text-3xl tracking-tight">{formatCurrency(selectedRequest.net_amount)}</span>
                                </div>
                                <div className="text-right">
                                    <span className="text-[10px] text-slate-700 font-black uppercase tracking-tight block mb-1">Phí hệ thống (2%)</span>
                        ...
                        <div className="p-10 bg-slate-50/90 dark:bg-zinc-900/90 border-t border-gray-100 dark:border-zinc-800/80 flex items-center gap-4">
                            <button 
                                ...
                                className="px-10 py-4 text-[11px] font-black uppercase tracking-tight text-slate-700 hover:text-gray-900 dark:hover:text-white bg-white dark:bg-zinc-800 border border-gray-200 dark:border-zinc-700 rounded-2xl transition-all shadow-sm active:scale-95"
                            >
                                QUAY LẠI
                            </button>
