  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-[440px] bg-dark-card border border-dark-border rounded-2xl shadow-2xl relative overflow-hidden flex flex-col glow-card-green">
        ...
        {/* Header Dark Mode */}
        <div className="border-b border-dark-border pt-10 pb-6 px-8 flex flex-col items-center justify-center">
          <Shield className="w-12 h-12 text-neon-green mb-4" />
          <h2 className="text-3xl font-bold text-white tracking-wide">
            Welcome Back
          </h2>
          <p className="text-gray-400 mt-2 text-sm">Secure login to your blockchain ticket wallet.</p>
        </div>
