...
const vnBlog = {
  ...
  org: {
    ...
    step1: "1. Thông tin",
    step2: "2. Hồ sơ KYC",
    step2_title: "Tải lên CCCD",
    step3_title: "Xác thực sinh trắc",
    step4_title: "Xác thực OTP",
    ...
    id_label: "Xác thực ID (CCCD/CMND)",
    front_side: "Mặt trước",
    back_side: "Mặt sau",
    license_label: "Giấy phép kinh doanh / Pháp lý",
    upload_license_hint: "Tải lên Giấy phép (.png, .jpg, .pdf)",
    license_uploaded: "Đã tải lên giấy tờ",
    ai_processing: "Đang bóc tách AI...",
    ai_retry: "Thử lại bóc tách",
    ai_result_title: "THÔNG TIN TRÍCH XUẤT",
    ai_verified: "XÁC MINH AI",
    full_name: "Họ và Tên",
    id_number: "Số CCCD",
    dob: "Ngày sinh",
    sex: "Giới tính",
    ...
    issue_date: "Ngày cấp",
    issue_loc: "Nơi cấp",
    biometric_title: "Xác thực sinh trắc",
    match_score: "Khớp",
    face_auth_success: "Xác thực sinh trắc học thành công!",
    send_otp_btn: "GỬI OTP",
    verify_btn: "Xác thực",
