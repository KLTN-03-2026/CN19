        ...
        translation: {
          ...
          support: {
            ...
            customerTerms: {
              ...
              s4i1: "Phí tiện ích hệ thống (System Fee).",
              s4i2: "Phí giao dịch mạng lưới Blockchain (Gas Fee) - thường được BASTICKET hỗ trợ chi trả.",
              s4i3: "Phí cổng thanh toán (VNPAY/Thẻ quốc tế).",
              s5Title: "5. Chuyển nhượng & Bán lại",
              s5p1: "BASTICKET hỗ trợ thị trường thứ cấp (Marketplace) cho phép người dùng thanh khoản vé:",
              s5transfer: "Chuyển nhượng", s5transferDesc: "Bạn có thể tặng vé cho bạn bè thông qua Email. Phí bản quyền có thể áp dụng tùy theo cài đặt của BTC.",
              s5resale: "Bán lại", s5resaleDesc: "Giá bán lại không được vượt quá 'Giá trần' do Nhà tổ chức quy định để ngăn chặn vé chợ đen.",
            ...
            organizerTerms: {
              ...
              s5boxTitle: "Cơ chế thu phí Marketplace",
              s5boxDesc: "BTC có quyền thiết lập % Phí bản quyền (ví dụ 5-10%) cho mỗi lần vé được bán lại trên thị trường thứ cấp. Khoản phí này được trích trực tiếp từ giá bán của khách hàng và cộng vào doanh thu của BTC.",
            ...
            refund: {
              ...
              note1: "Phí dịch vụ (System Fee) và Phí Blockchain (Gas Fee) thường sẽ không được hoàn lại vì đây là chi phí hạ tầng đã phát sinh khi tạo vé NFT.",
            ...
            faq: {
              ...
              q5: "Tôi có thể bán lại vé với giá cao hơn không?", a5: "Có, nhưng mức giá bán lại bị giới hạn bởi 'Giá trần' do Nhà tổ chức quy định để bảo vệ người hâm mộ khỏi tình trạng vé chợ đen.",
              q11: "Làm thế nào để đăng vé lên Marketplace bán lại?", a11: "Vào 'Vé của tôi', chọn vé muốn bán, nhấn 'Đăng bán trên Marketplace', đặt giá mong muốn (trong giới hạn Giá trần) và xác nhận. Vé của bạn sẽ hiển thị ngay lập tức.",
              q12: "Phí Royalty là gì và ai nhận được?", a12: "Phí Royalty là một % (ví dụ 5-10%) do Nhà tổ chức thiết lập trên mỗi lần vé được bán lại ở thị trường thứ cấp. Khoản này tự động được trừ khỏi giá bán và chuyển vào tài khoản BTC qua Smart Contract.",
